...
const prepareInfoFromTriggerData = (type: string, {
	...
	if (type === 'device') {
		...
		switch (deviceType) {
			case 1: {
				return {
					label: `When ${name} is turned on`,
					leftIcon: TURNON,
				};
			}
			case 2: {
				return {
					label: `When ${name} is turned off`,
					leftIcon: TURNON,
				};
			}
			case 4: {
				return {
					label: `When ${name} bell`,
					leftIcon: TURNON,
				};
			}
			case 16: {
			...
			case 64: {
				return {
					label: `When ${name} executes`,
					leftIcon: TURNON,
				};
			}
			case 128: {
				return {
					label: `When ${name} goes up`,
					leftIcon: TURNON,
				};
			}
			case 256: {
				return {
					label: `When ${name} goes down`,
					leftIcon: TURNON,
				};
			}
			case 512: {
				return {
					label: `When ${name} stop`,
					leftIcon: TURNON,
				};
			}
			case 1024: {
				return {
					label: `When ${name} color change`,
					leftIcon: TURNON,
				};
			}
			case 2048: {
				return {
					label: `When ${name} mode/value change`,
					leftIcon: TURNON,
				};
			}
			default: {
