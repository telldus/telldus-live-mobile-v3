 ...
 *
 * @providesModule EditFenceArrivingView
 */
...
class EditFenceArrivingView extends View {
...
function mapDispatchToProps(dispatch) {
    return {
        onSave: (actions) => dispatch(setFenceArrivingActions(actions)),
        dispatch,
    };
}


module.exports = connect(mapStateToProps, mapDispatchToProps)(EditFenceArrivingView);
