 ...
 *
 * @providesModule AddFenceLeavingView
 */
...
class AddFenceLeavingView extends View {
    ...
    toTime() {
        this.props.setFenceLeavingActions({
            devices: this.state.devices,
            events: this.state.events,
            schedules: this.state.schedules
        });
        this.props.navigation.navigate('AddFenceTime');
    }
...
function mapDispatchToProps(dispatch) {
    return {
        setFenceLeavingActions: (actions) => dispatch(setFenceLeavingActions(actions)),
        dispatch,
    };
}


module.exports = connect(mapStateToProps, mapDispatchToProps)(AddFenceLeavingView);
