...
describe('<SensorLastUpdateModeControlBlock /> - snapshot', () => {
	it('renders SensorLastUpdateModeControlBlock', () => {
		let component;
		act(() => {
			...
			component = rendererWithIntlAndReduxProviders(<SensorLastUpdateModeControlBlock/>);
		});
