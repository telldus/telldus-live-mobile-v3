...
function getLocale(short: boolean = true): string {
	...
	console.log('TEST localeIdentifier', localeIdentifier);
	if (!short) {
...
const getSupportedLanguages = (): Array<Object> => {
	return [
		{key: 'cs', value: 'Czechia', code: 'cs'},
		{key: 'de', value: 'Deutsche', code: 'de'},
		{key: 'en', value: 'English', code: 'de'},
		{key: 'fr', value: 'française', code: 'de'},
		{key: 'nb', value: 'Norwegian Bokmål', code: 'de'},
		{key: 'sv', value: 'Svenska', code: 'de'},
	];
};
...
const getLanguageNameFromLangCode = (code: string): string => {
	let name = '';
