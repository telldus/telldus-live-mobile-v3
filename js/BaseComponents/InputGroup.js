...
export default class InputGroup extends Base {
	...
	prepareRootProps() {
		...
		let defaultStyle = (this.props.borderType === 'regular') ? this.getInitialStyle().bordered
			: (this.props.borderType === 'rounded') ? this.getInitialStyle().rounded : this.getInitialStyle().underline;
	...
	renderChildren() {
		...
		if (Array.isArray(this.props.children)) {
			...
			if (this.props.iconRight) {
				newChildren.push(<Input key="inp" {...inputProps} style={{
